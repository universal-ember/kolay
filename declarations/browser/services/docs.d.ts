...
export declare function compilerOptions({ rootURL, topLevelScope, remarkPlugins, rehypePlugins, modules, formatOptions, }?: {
    /**
...
declare class DocsService {
     ...
     */
    get tree(): import("../index.ts").PageTree;
    /**
    ...
    get currentGroup(): {
        name: string;
        list: Page[];
        tree: import("../index.ts").PageTree;
        meta: import("../load-compiled-docs.ts").DocsSourceMeta;
    };
    /**

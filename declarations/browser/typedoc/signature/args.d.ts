...
export declare function listifyArgs(info: DeclarationReflection | Reflection): any[];
/**
 * Returns args for either a function or signature
 */
export declare function getArgs(info?: Reflection | SignatureReflection | DeclarationReflection | DeclarationReflection[]): DeclarationReflection | import("typedoc").ParameterReflection[] | undefined;

 ...
 */
export function betterSort(property?: string | undefined): (a: any, b: any) => any;
/**
 * @template Item
 * @param {Item[]} list
 * @param {string[]} order
 ...
 * @returns {Item[]}
 */
export function applyPredestinedOrder<Item>(list: Item[], order: string[], find?: ((item: Item) => any) | undefined): Item[];
/**

 ...
 */
export function docs(groupName?: string | import("./plugins/docs-args.js").DocsOptions, options?: import("./plugins/docs-args.js").DocsOptions): import("unplugin").VitePlugin<any> | import("unplugin").VitePlugin<any>[];
/**
 ...
 */
export const apiDocs: (options: string | string[]) => import("unplugin").VitePlugin<any> | import("unplugin").VitePlugin<any>[];
/**
 * One redirect: an old path and where it now lives. A trailing `/*`
 * (on both `from` and `to`) matches the whole subtree.
 */
...
export type MarkdownOptions = {
     ...
     */
    populateManifestEntry?: import("./plugins/index.js").PopulateManifestEntry | undefined;
};
/**
 * One `docs()` usage. A plain string entry is shorthand for a path
 * whose last segment names the group.

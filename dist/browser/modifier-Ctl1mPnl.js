...
function lru(key, compute) {
  let value = defaultCache.get(key);
  if (value === undefined) {
    value = compute(key);
...
function compileText(owner, text) {
  return lru(text, () => compile(getCompiler(owner), text, {
    /**
...
export { APIDocs as A, CommentQuery as C, HelperSignature as H, ModifierSignature as M, isCollection as a, Compiled as b, ComponentSignature as c, compileText as d, getKey as e, forceFindOwner as f, getIndexPage as g, isIndex as i, setupSecret as s, typedocLoader as t };
//# sourceMappingURL=modifier-Ctl1mPnl.js.map

...
export default defineConfig({
  ...
  redirects: [
    ...
    { from: 'Runtime/util/collection-utils', to: 'Runtime/utilities/page-tree-utils.md' },
    // 2026-08: PageTree was renamed PageTree, and the page with it
    { from: 'Runtime/utilities/collection-utils', to: 'Runtime/utilities/page-tree-utils.md' },

 ...
 * @property {import('./markdown-pages/populate-manifest-entry.js').PopulateManifestEntry} [populateManifestEntry] - finalizes each page or directories manifest entry: receives the default entry and any YAML frontmatter (for pages), and returns the entry to use; defaults to `defaultPopulateManifestEntry`, which nests the frontmatter under `meta`
 */
